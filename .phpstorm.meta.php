...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/erion/bunter/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/erion/bunter/public/storage',
...
'hashing.argon.threads','hashing.argon.time','hashing.argon.verify','hashing.rehash_on_login','scout.driver',
...
'scout.typesense.client-settings.retry_interval_seconds','scout.typesense.model-settings','markdown.views','markdown.extensions','markdown.renderer.block_separator',
...
'markdown.slug_normalizer.max_length','markdown.slug_normalizer.unique','tinker.commands','tinker.alias','tinker.dont_alias',);
...
'sanctum.csrf-cookie','auth.signup','home',
'login','storage.local',);
        registerArgumentsSet('views', 
'auth.passwords.confirm','auth.passwords.email','auth.passwords.reset','auth.signin','auth.signup',
'auth.verify','home','layouts.app','layouts.navbar','layouts.search',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','SCOUT_DRIVER','ELASTICSEARCH_HOST',
'ELASTICSEARCH_SSL_VERIFICATION','VITE_APP_NAME',);
